...
"
    ...
    highlight CursorLine   term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
    highlight DiffAdd      term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
    highlight DiffChange   term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
    highlight DiffDelete   term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
    ...
    highlight Identifier   term=NONE cterm=bold ctermfg=7    ctermbg=NONE
    highlight IncSearch    term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
    ...
    highlight Pmenu        term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
    highlight PreProc      term=NONE cterm=bold ctermfg=7    ctermbg=NONE
    highlight Search       term=NONE cterm=bold ctermfg=0    ctermbg=7
    highlight Special      term=NONE cterm=bold ctermfg=7    ctermbg=NONE
    ...
    highlight StatusLine   term=NONE cterm=NONE ctermfg=0    ctermbg=7
    highlight StatusLineNC term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
    highlight String       term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
    highlight Todo         term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
    highlight Type         term=NONE cterm=NONE ctermfg=7    ctermbg=NONE
