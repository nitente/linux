...
"
    ...
    "
    highlight Comment      term=NONE cterm=bold ctermfg=4    ctermbg=NONE
    highlight Constant     term=NONE cterm=bold ctermfg=0    ctermbg=NONE
    highlight Cursor       term=NONE cterm=bold ctermfg=0    ctermbg=NONE
    highlight CursorLine   term=NONE cterm=NONE ctermfg=0    ctermbg=NONE
    highlight DiffAdd      term=NONE cterm=NONE ctermfg=0    ctermbg=NONE
    highlight DiffChange   term=NONE cterm=NONE ctermfg=0    ctermbg=NONE
    highlight DiffDelete   term=NONE cterm=NONE ctermfg=0    ctermbg=NONE
    highlight Folded       term=NONE cterm=bold ctermfg=0    ctermbg=NONE
    highlight Function     term=NONE cterm=bold ctermfg=0    ctermbg=NONE
    highlight Identifier   term=NONE cterm=bold ctermfg=0    ctermbg=NONE
    ...
    highlight PreProc      term=NONE cterm=bold ctermfg=0    ctermbg=NONE
    highlight Search       term=NONE cterm=bold ctermfg=7    ctermbg=0
    ...
    highlight Statement    term=NONE cterm=bold ctermfg=0    ctermbg=NONE
    highlight StatusLine   term=NONE cterm=NONE ctermfg=7    ctermbg=0
    highlight StatusLineNC term=NONE cterm=NONE ctermfg=0    ctermbg=NONE
    highlight String       term=NONE cterm=NONE ctermfg=0    ctermbg=NONE
    highlight Todo         term=NONE cterm=NONE ctermfg=0    ctermbg=NONE
    highlight Type         term=NONE cterm=NONE ctermfg=0    ctermbg=NONE
    highlight VertSplit    term=NONE cterm=bold ctermfg=0    ctermbg=NONE
    highlight Visual       term=NONE cterm=bold ctermfg=7    ctermbg=0
